...
if ($result->num_rows > 0) {
    ...
    echo "<thead><tr><th class='px-4 py-2 border'>Title</th><th class='px-4 py-2 border'>Description</th><th class='px-4 py-2 border'>Due Date</th><th class='px-4 py-2 border'>Priority</th><th class='px-4 py-2 border'>Status</th><th class='px-4 py-2 border'>Actions</th></tr></thead>";
    echo "<tbody>";
    ...
    echo "<p>No tasks found. <a href='../HTML/create_task.html'>Create a new task</a>.</p>";
}
